...
from qualitative_model_fitting._test_factory import TestCase, TestFactory
...
class TestTestCase(unittest.TestCase):
    ...
    def test_dynamic_class_creation_point_to_point0(self):
        ...
        self.cls = type(self.name, (TestCase,), {})
        methods = self.cls(data=self.data['InsulinOnly'], obs=statement).make_tests()
    ...
    def test_dynamic_class_creation_point_to_point1(self):
        ...
        cls = type(self.name, (TestCase,), {})
        insulin_only_obj = cls(obs=statement, data=self.data['InsulinOnly'])
